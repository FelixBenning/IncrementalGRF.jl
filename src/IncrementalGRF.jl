...
export PackedLowerTriangular, GaussianRandomFunction, DifferentiableGRF, Kernels, CovarianceKernel, StationaryKernel, IsotropicKernel, conditionalExpectation
